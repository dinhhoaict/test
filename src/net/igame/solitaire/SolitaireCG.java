...
public class SolitaireCG extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			VERSION_NAME = getPackageManager().getPackageInfo(getPackageName(),
					0).versionName;
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		SubMenu subMenu = menu.addSubMenu(0, MENU_SELECT_GAME, 0,
				R.string.menu_selectgame);
		...
		subMenu.add(0, MENU_KLONDIKE_DEALTHREE, 0,
				R.string.menu_klondike_dealthree);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case MENU_VEGAS_DEALTHREE:
			...
			break;
		case MENU_NEW:
			mSolitaireView.InitGame(mSettings
					.getInt("LastType", Rules.KLONDIKE));
			break;
		case MENU_RESTART:
	...
	// This is called for option changes that require a refresh, but not a new
	// game
